...
@section('content')
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="index.html">Larain Aja</a>
            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            <h5 class="font-bold">Byyy</h5>
                            <h6 class="text-muted mb-0">@splitsploit</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; Larain Aja | Mazer Redev</p>
                    </div>
                    <div class="float-end">
                        <p>Made with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                                href="https://byby.my.id">SplitSploit</a></p>
                    </div>
                </div>
            </footer>
        </div>
